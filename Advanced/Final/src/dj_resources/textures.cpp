 ...
 * 	Adapted from the CSCIx2329 Library
 */
unsigned int LoadTexBMP(const char* file)
{
   ...
   if ((int)dx<1 || (int)dx>max) Fatal("%s image width %d out of range 1-%d\n",file,dx,max);
   if ((int)dy<1 || (int)dy>max) Fatal("%s image height %d out of range 1-%d\n",file,dy,max);
